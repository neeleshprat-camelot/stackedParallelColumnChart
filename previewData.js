			...
			"data": {
				"analysisAxis": [{
					...
					"data": [{
						"type": "Dimension",
						"name": "Year (TD)",
						"values": ["2016", "2016", "2016", "2016", "2016", "2016", "2016", "2016", "2016", "2016", "2016", "2016"]
					}, {
						"type": "Dimension",
						"name": "Time Division",
						"values": [".YTD", "FC+3", "FC+6", ".YTD", ".YTD", "FC+3", ".YTD", ".YTD", ".YTD", "FC+6", "FC+6", "FC+3"]
					}, {
						"type": "Dimension",
						"name": "Month (TD)",
						"values": ["April", "August", "December", "February", "January", "July", "June", "May", "March", "November", "October",
							"September"
						]
					}]
				}],
				"measureValuesGroup": [{
					...
					"data": [{
						...
						"name": "Capacity",
						"values": [
							[3932.775, 4006.05, 4220.1, 3840.149, 2971.575, 3843.85, 4040.175, 2986.2, 3392.35, 4347.1, 4053, 4181.95]
						]
					}]
				}, {
					"index": 2,
					"data": [{
						...
						"values": [
							[2963.267, 2265.75, 1008.75, 2865.148, 2286.356, 2841.175, 2859.279, 2560.216, 2905.04, 1147.75, 1347.25, 1763.5]
						]
					}, {
						"type": "Measure",
						"name": "Opportunities",
						"values": [
							[0, 631.184, 1362.566, 0, 0, 326.364, 16, 0, 0, 1460.607, 1824.761, 957.905]
						]
					}]
				}]
			},
